...
export default function Compliance() {
  ...
  const copy = siteCopy?.compliance ?? defaultSiteCopy.compliance;
    ...
    <AnimatedPage>
      ...
      <div className="bg-accent/10 border-2 border-accent/25 rounded-3xl p-8 md:p-12 mb-12 relative overflow-hidden">
        <div className="relative z-10">
          <h2 className="text-3xl font-bold font-outfit mb-4 text-accent">{copy.heroTitle}</h2>
      ...
      <div className="bg-card rounded-3xl p-8 md:p-12 border border-border/50 shadow-md">
        <h3 className="text-2xl font-bold font-outfit mb-6">{copy.mandatesTitle}</h3>
