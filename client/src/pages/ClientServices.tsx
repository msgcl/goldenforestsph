...
export default function ClientServices() {
  ...
  const copy = siteCopy?.clientServices ?? defaultSiteCopy.clientServices;
    ...
    <AnimatedPage>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        <Card className="border-border/60 shadow-md hover-elevate">
          <CardContent className="p-8">
            ...
            <h3 className="text-2xl font-bold font-outfit mb-3">{copy.serviceTitles[0] ?? ""}</h3>
        ...
        <Card className="border-border/60 shadow-md hover-elevate">
          <CardContent className="p-8">
            ...
            <h3 className="text-2xl font-bold font-outfit mb-3">{copy.serviceTitles[1] ?? ""}</h3>
            <p className="text-muted-foreground mb-6 leading-relaxed">
      ...
      <div className="bg-card rounded-3xl overflow-hidden border border-border/60 shadow-lg flex flex-col md:flex-row">
        <div className="md:w-2/5 bg-[#17392E] p-8 flex flex-col justify-center relative">
          ...
          <h3 className="text-3xl font-bold font-outfit text-accent mb-4">{copy.visitationTitle}</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="font-bold text-foreground">{copy.logisticsTitle}</h4>
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="font-bold text-foreground">{copy.itineraryTitle}</h4>
              </div>
              <p className="text-sm text-muted-foreground leading-relaxed">
